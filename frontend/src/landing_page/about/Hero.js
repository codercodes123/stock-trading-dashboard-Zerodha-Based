  ...
  return (
    <div className="container">
      <div className="row p-5 mb-5 mt-5">
        <h1 className="text-center fs-3 " style={{ color: "#424242" }}>
      ...
      <div className="row p-5 mt-5 border-top text-muted ">
        <div className="col-6 p-5 fs-5 text" style={{lineHeight:"1.8"}}>
          <p>
        ...
        <div className="col-6  p-5 fs-5" style={{lineHeight:"1.8"}}>
            ...
            <p>And yet, we are always up to something new every day. Catch up on the latest updates on our <a href="https://zerodha.com/z-connect/" style={{textDecoration:"none",}}>blog </a> or see what the media is<a href="https://zerodha.com/media" style={{textDecoration:"none",}}> saying about us</a> or learn more about our business and product <a href="https://zerodha.com/about/philosophy/" style={{textDecoration:"none",}}>philosophies.</a></p>
        </div>
      </div>
    </div>
  );
